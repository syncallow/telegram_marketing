...
import TelegramAuthStatus from "@/Components/TelegramAuthStatus.vue";
</script>
            ...
            <div class="flex items-center lg:order-2">
                    ...
                    <div>
                        ...
                        >
                            <div class="flex-shrink-0">
                                ...
                                />
                                <div
                                    class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 rounded-full border border-white bg-emerald-700 dark:border-gray-700"
                                >
                                    <svg
                                        aria-hidden="true"
              ...
              >
                  ...
                  <span class="flex items-center">
                    <svg
                        aria-hidden="true"
                        class="mr-2 w-5 h-5 text-emerald-600 dark:text-emerald-500"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"
                    >
